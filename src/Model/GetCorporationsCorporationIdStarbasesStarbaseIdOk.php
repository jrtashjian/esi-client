...
class GetCorporationsCorporationIdStarbasesStarbaseIdOk implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'fuels' => '\EsiClient\EsiClient\Model\GetCorporationsCorporationIdStarbasesStarbaseIdFuel[]',
        'offline' => 'string',
        'online' => 'string',
        'unanchor' => 'string',
     ...
     * Gets fuels
     *
     * @return \EsiClient\EsiClient\Model\GetCorporationsCorporationIdStarbasesStarbaseIdFuel[]
     */
     ...
     * Sets fuels
     *
     * @param \EsiClient\EsiClient\Model\GetCorporationsCorporationIdStarbasesStarbaseIdFuel[] $fuels Fuel blocks and other things that will be consumed when operating a starbase (POS)
     *
     * @return $this
     */
