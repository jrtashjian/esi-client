...
class GetSovereigntyCampaigns200Ok implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'event_type' => 'string',
        'participants' => '\EsiClient\EsiClient\Model\GetSovereigntyCampaignsParticipant[]',
        'solar_system_id' => 'int',
        'start_time' => '\DateTime',
        'structure_id' => 'int'
    ];
     ...
     * Gets participants
     *
     * @return \EsiClient\EsiClient\Model\GetSovereigntyCampaignsParticipant[]
     */
     ...
     * Sets participants
     *
     * @param \EsiClient\EsiClient\Model\GetSovereigntyCampaignsParticipant[] $participants Alliance participating and their respective scores, only present in Freeport Events.
     *
     * @return $this
     */
