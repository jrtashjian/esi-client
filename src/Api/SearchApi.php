...
class SearchApi
{
     ...
     * @return \EsiClient\EsiClient\Model\GetCharactersCharacterIdSearchOk
     */
     ...
     * @throws \EsiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EsiClient\EsiClient\Model\GetCharactersCharacterIdSearchOk, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EsiClient\EsiClient\Model\GetCharactersCharacterIdSearchOk';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EsiClient\EsiClient\Model\GetCharactersCharacterIdSearchOk',
     ...
     * @throws \EsiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EsiClient\EsiClient\Model\GetSearchOk
     */
     ...
     * @throws \EsiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EsiClient\EsiClient\Model\GetSearchOk, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EsiClient\EsiClient\Model\GetSearchOk';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EsiClient\EsiClient\Model\GetSearchOk',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
