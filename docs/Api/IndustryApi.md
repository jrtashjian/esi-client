...
$apiInstance = new EsiClient\EsiClient\Api\IndustryApi(
 ...
 **datasource** | **string**| The server name you would like data from | [optional]
 **if_none_match** | **string**| ETag from a previous request. A 304 will be returned if this matches the current ETag | [optional]
 **include_completed** | **bool**| Whether to retrieve completed corporation industry jobs. Only includes jobs from the past 90 days | [optional]
 **page** | **int**| Which page of results to return | [optional]
 **token** | **string**| Access token to use if unable to set a header | [optional]
