...
# **getInsurancePrices**
> \EsiClient\EsiClient\Model\GetInsurancePrices200Ok[] getInsurancePrices($datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetInsurancePrices200Ok[]**](../Model/GetInsurancePrices200Ok.md)
