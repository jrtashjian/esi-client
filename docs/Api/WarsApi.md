...
# **getWarsWarId**
> \EsiClient\EsiClient\Model\GetWarsWarIdOk getWarsWarId($war_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetWarsWarIdOk**](../Model/GetWarsWarIdOk.md)
...
> \EsiClient\EsiClient\Model\GetWarsWarIdKillmails200Ok[] getWarsWarIdKillmails($war_id, $datasource, $if_none_match, $page, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetWarsWarIdKillmails200Ok[]**](../Model/GetWarsWarIdKillmails200Ok.md)
