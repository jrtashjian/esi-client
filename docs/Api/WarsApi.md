...
# **getWarsWarId**
> \EsiClient\EsiClient\Model\GetWarsWarIdOk getWarsWarId($war_id, $datasource, $if_none_match)
...
> \EsiClient\EsiClient\Model\GetWarsWarIdKillmails200Ok[] getWarsWarIdKillmails($war_id, $datasource, $if_none_match, $page)
