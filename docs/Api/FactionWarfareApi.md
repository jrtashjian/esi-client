...
> \EsiClient\EsiClient\Model\GetCharactersCharacterIdFwStatsOk getCharactersCharacterIdFwStats($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetCorporationsCorporationIdFwStatsOk getCorporationsCorporationIdFwStats($corporation_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent)
...
# **getFwLeaderboards**
> \EsiClient\EsiClient\Model\GetFwLeaderboardsOk getFwLeaderboards($datasource, $if_none_match, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetFwLeaderboardsCharactersOk getFwLeaderboardsCharacters($datasource, $if_none_match, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetFwLeaderboardsCorporationsOk getFwLeaderboardsCorporations($datasource, $if_none_match, $user_agent, $x_user_agent)
...
# **getFwStats**
> \EsiClient\EsiClient\Model\GetFwStats200Ok[] getFwStats($datasource, $if_none_match, $user_agent, $x_user_agent)
...
# **getFwSystems**
> \EsiClient\EsiClient\Model\GetFwSystems200Ok[] getFwSystems($datasource, $if_none_match, $user_agent, $x_user_agent)
...
# **getFwWars**
> \EsiClient\EsiClient\Model\GetFwWars200Ok[] getFwWars($datasource, $if_none_match, $user_agent, $x_user_agent)
