...
> \EsiClient\EsiClient\Model\GetCharactersCharacterIdFittings200Ok[] getCharactersCharacterIdFittings($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\PostCharactersCharacterIdFittingsCreated postCharactersCharacterIdFittings($character_id, $fitting, $datasource, $token, $user_agent, $x_user_agent)
