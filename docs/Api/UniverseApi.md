...
> \EsiClient\EsiClient\Model\GetUniverseAncestries200Ok[] getUniverseAncestries($datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetUniverseAncestries200Ok[]**](../Model/GetUniverseAncestries200Ok.md)
...
> \EsiClient\EsiClient\Model\GetUniverseAsteroidBeltsAsteroidBeltIdOk getUniverseAsteroidBeltsAsteroidBeltId($asteroid_belt_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseBloodlines200Ok[] getUniverseBloodlines($datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetUniverseBloodlines200Ok[]**](../Model/GetUniverseBloodlines200Ok.md)
...
> \EsiClient\EsiClient\Model\GetUniverseCategoriesCategoryIdOk getUniverseCategoriesCategoryId($category_id, $datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseConstellationsConstellationIdOk getUniverseConstellationsConstellationId($constellation_id, $datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
# **getUniverseFactions**
> \EsiClient\EsiClient\Model\GetUniverseFactions200Ok[] getUniverseFactions($datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetUniverseFactions200Ok[]**](../Model/GetUniverseFactions200Ok.md)
...
> \EsiClient\EsiClient\Model\GetUniverseGraphicsGraphicIdOk getUniverseGraphicsGraphicId($graphic_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseGroupsGroupIdOk getUniverseGroupsGroupId($group_id, $datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseMoonsMoonIdOk getUniverseMoonsMoonId($moon_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniversePlanetsPlanetIdOk getUniversePlanetsPlanetId($planet_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
...
# **getUniverseRaces**
> \EsiClient\EsiClient\Model\GetUniverseRaces200Ok[] getUniverseRaces($datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetUniverseRaces200Ok[]**](../Model/GetUniverseRaces200Ok.md)
...
> \EsiClient\EsiClient\Model\GetUniverseRegionsRegionIdOk getUniverseRegionsRegionId($region_id, $datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseStargatesStargateIdOk getUniverseStargatesStargateId($stargate_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseStarsStarIdOk getUniverseStarsStarId($star_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseStationsStationIdOk getUniverseStationsStationId($station_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseStructuresStructureIdOk getUniverseStructuresStructureId($structure_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseSystemJumps200Ok[] getUniverseSystemJumps($datasource, $if_none_match, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetUniverseSystemJumps200Ok[]**](../Model/GetUniverseSystemJumps200Ok.md)
...
> \EsiClient\EsiClient\Model\GetUniverseSystemKills200Ok[] getUniverseSystemKills($datasource, $if_none_match, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetUniverseSystemKills200Ok[]**](../Model/GetUniverseSystemKills200Ok.md)
...
> \EsiClient\EsiClient\Model\GetUniverseSystemsSystemIdOk getUniverseSystemsSystemId($system_id, $datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
> \EsiClient\EsiClient\Model\GetUniverseTypesTypeIdOk getUniverseTypesTypeId($type_id, $datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
# **postUniverseIds**
> \EsiClient\EsiClient\Model\PostUniverseIdsOk postUniverseIds($names, $datasource, $language, $user_agent, $x_user_agent)
...
# **postUniverseNames**
> \EsiClient\EsiClient\Model\PostUniverseNames200Ok[] postUniverseNames($ids, $datasource, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\PostUniverseNames200Ok[]**](../Model/PostUniverseNames200Ok.md)
