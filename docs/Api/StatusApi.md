...
# **getStatus**
> \EsiClient\EsiClient\Model\GetStatusOk getStatus($datasource, $if_none_match, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetStatusOk**](../Model/GetStatusOk.md)
