...
> \EsiClient\EsiClient\Model\GetCharactersCharacterIdSearchOk getCharactersCharacterIdSearch($categories, $character_id, $search, $datasource, $if_none_match, $language, $strict, $token, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetCharactersCharacterIdSearchOk**](../Model/GetCharactersCharacterIdSearchOk.md)
...
# **getSearch**
> \EsiClient\EsiClient\Model\GetSearchOk getSearch($categories, $search, $datasource, $if_none_match, $language, $strict, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetSearchOk**](../Model/GetSearchOk.md)
