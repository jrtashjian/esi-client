...
> \EsiClient\EsiClient\Model\GetCharactersCharacterIdOpportunities200Ok[] getCharactersCharacterIdOpportunities($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent)
...
$apiInstance = new EsiClient\Api\OpportunitiesApi(
...
[**\EsiClient\EsiClient\Model\GetCharactersCharacterIdOpportunities200Ok[]**](../Model/GetCharactersCharacterIdOpportunities200Ok.md)
...
> \EsiClient\EsiClient\Model\GetOpportunitiesGroupsGroupIdOk getOpportunitiesGroupsGroupId($group_id, $datasource, $if_none_match, $language, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetOpportunitiesGroupsGroupIdOk**](../Model/GetOpportunitiesGroupsGroupIdOk.md)
...
> \EsiClient\EsiClient\Model\GetOpportunitiesTasksTaskIdOk getOpportunitiesTasksTaskId($task_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
...
[**\EsiClient\EsiClient\Model\GetOpportunitiesTasksTaskIdOk**](../Model/GetOpportunitiesTasksTaskIdOk.md)
